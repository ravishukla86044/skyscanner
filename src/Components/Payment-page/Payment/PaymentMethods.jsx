  ...
  return (
    <>
      <div className={styles.paymentmethods}>
        <h2 className={styles.paymentcard}>Payment with Card</h2>
        ...
        <div className={styles.payOptions}>
          ...
          />
          <img
            src="https://s.cdnsbn.com/images/common/AmericanExpress.png"
            alt=""
          />
        ...
        {selectedValue === "" && (
          <button className={styles.center}>Pay Now</button>
        )}
      </div>
    </>
  );
