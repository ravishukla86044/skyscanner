    ...
    return (
        <div>
            <Container maxWidth="lg" className={styledd.containerHead}>
                ...
                <Button variant="contained" className={classes.headBtn1}>English(U.S)  INDIA ₹ INR</Button>
                {logg==="Login" ? 
                <Button variant="contained" className={classes.headBtn2} onClick={handleOpen}>Log in</Button>: 
